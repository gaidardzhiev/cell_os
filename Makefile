...
KERNEL_CFLAGS := -std=gnu11 -Os -Wall -Wextra -Werror -ffreestanding \
...
$(BUILD_DIR)/test_c_runtime: src/core/cc.c src/core/cellexec.c src/core/task.c src/core/cellfs.c src/core/vfs.c src/core/capability.c tests/test_c_runtime.c include/core/cc.h include/core/cellexec.h include/core/task.h
	@mkdir -p $(BUILD_DIR)
	$(CC) -std=c11 -O2 -Wall -Wextra -Werror -Iinclude \
		src/core/cc.c src/core/cellexec.c src/core/task.c src/core/cellfs.c src/core/vfs.c src/core/capability.c tests/test_c_runtime.c -o $@
